...
@WebServlet("/PaymentManage")
public class PaymentManage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = PaymentObj.insertPayment(
				request.getParameter("payAccNo"),      
				request.getParameter("payDate"),
				request.getParameter("payEmail"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 ...
		 String output = PaymentObj.updatePayment(
		    		...
		    		paras.get("payAccNo").toString(),     
		    		paras.get("payDate").toString(),
		    		paras.get("payEmail").toString(),
